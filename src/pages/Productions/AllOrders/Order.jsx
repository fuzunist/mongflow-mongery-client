...
import { useExpenses, useExchangeRates, useOrders } from "@/store/hooks/apps";
                          ...
                          <span className="basis-[calc(10%_-_0.5rem)] mx-1 text-center">
                            ...
                            {formatDigits(
                              (product.totalCost * 0.4444) /
                                (product.quantity / 1000) //product.quantity kg to ton çevirmesi
                            )}{" "}
